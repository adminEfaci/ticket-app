#!/usr/bin/env python3
"""
Fix client_router.py to use User objects instead of dicts
"""

import re

# Read the file
with open('/app/backend/routers/client_router.py', 'r') as f:
    content = f.read()
...
# Write the file back
with open('/app/backend/routers/client_router.py', 'w') as f:
    f.write(content)

print("Fixed client_router.py")