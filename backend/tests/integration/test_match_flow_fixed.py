...
class TestMatchFlowIntegration:
    ...
    def sample_tickets(self):
        ...
        # Add attributes for fuzzy matching
        ticket1.reference = "REF123"
        ticket1.customer_reference = "REF123"
        ...
        ticket2.reference = "REF456"
        ticket2.customer_reference = "REF456"
    ...
    @pytest.mark.asyncio
    async def test_match_flow_with_no_tickets(self, match_service, sample_images, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_match_review_workflow(self, match_service, mock_session):
    ...
    def test_conflict_resolution_flow(self):
        ...
        ticket1.entry_date = date(2023, 1, 15)
        ticket1.net_weight = 10.5
        # Add required attributes for fuzzy matching
        ticket1.reference = "REF123"
        ticket1.customer_reference = "REF123"
        ...
        ticket2.reference = "REF123"
        ticket2.customer_reference = "REF123"
    ...
    @pytest.mark.asyncio
    async def test_batch_statistics_calculation(self, match_service, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_review_queue_functionality(self, match_service, mock_session):
        ...
        async def mock_get_match_results(**kwargs):
        ...
        match_service.get_match_results = mock_get_match_results
        
        # Get review queue
        queue_items = await match_service.get_review_queue(batch_id=batch_id)
